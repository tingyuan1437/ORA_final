...
train_samples_path = './data/train_in_7words_id.trc'
summary_samples_path = './data/train_out_7words_id.trc'
val_samples_path = './data/test_in_7words_id.trc'
val_summary_samples_path = './data/test_out_7words_id.trc'
